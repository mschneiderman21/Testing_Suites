...
def downlink(frm_payload):  
  ...
  payload = requests.post(f'{base}/as/applications/temp-sensor/devices/em320-tilt/down/push', json=data,  headers=headers)
...
def get_uplinks(num):
  ...
  payload = requests.get(f'{base}/as/applications/temp-sensor/devices/em320-tilt/packages/storage/uplink_message', headers=headers, params=params)
